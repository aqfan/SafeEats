...
app.post('/checkGoogle', function(request, response) {
  ...
  // *TODO:
  // insert query - if user exists, log them in else run below code/send error
  // to let user know they're being added
  response.status(500).send();
})

app.post('/addGoogle', function(request, response) {
